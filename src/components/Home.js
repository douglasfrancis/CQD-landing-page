  ...
  return (
    <div id='home'>
        <div id='home-info'>
            ...
            <p style={{fontSize:'1.2rem', fontFamily: 'GothamBold', color:'#919191'}}>Our home care app makes it simple to manage all of your clients and staff easily and effectively, allowing you to continue giving great care.</p>
            <div>
              <form ref={form}>
